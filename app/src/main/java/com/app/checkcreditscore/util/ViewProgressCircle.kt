...
// progress layout binding class
class ViewProgressCircle : View {
    ...
    private val helperResourceResolver: Resolver = ResolverImpl(
        context
    )
    private val helperDimensions = ProgressCircle(
